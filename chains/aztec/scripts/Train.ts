...
HTLC_Private: {
  ...
  public declare methods: {
    ...
    /** lock_private_solver(Id: field, hashlock: array, amount: integer, timelock: integer, token: struct, randomness: field, dst_chain: string, dst_asset: string, dst_address: string) */
    lock_private_solver: ((Id: FieldLike, hashlock: (bigint | number)[], amount: (bigint | number), timelock: (bigint | number), token: AztecAddressLike, randomness: FieldLike, dst_chain: string, dst_asset: string, dst_address: string) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;

    /** public_dispatch(selector: field) */
    public_dispatch: ((selector: FieldLike) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;

    /** redeem_private(Id: field, secret: array, randomness: field) */
    redeem_private: ((Id: FieldLike, secret: (bigint | number)[], randomness: FieldLike) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;

    /** refund_private(Id: field, randomness: field) */
    refund_private: ((Id: FieldLike, randomness: FieldLike) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;
    ...
    public static get events(): { TokenRefunded: {abiType: AbiType, eventSelector: EventSelector, fieldNames: string[] }, TokenRedeemed: {abiType: AbiType, eventSelector: EventSelector, fieldNames: string[] }, TokenLocked: {abiType: AbiType, eventSelector: EventSelector, fieldNames: string[] }, TokenLockAdded: {abiType: AbiType, eventSelector: EventSelector, fieldNames: string[] }, TokenCommitted: {abiType: AbiType, eventSelector: EventSelector, fieldNames: string[] } } {
    return {
      TokenRefunded: {
        abiType: {
    "kind": "struct",
    ...
    "path": "Train::TokenRefunded"
        ...
        eventSelector: EventSelector.fromString("0x8b6918c1"),
        fieldNames: ["Id"],
      },
TokenRedeemed: {
        abiType: {
...
TokenLocked: {
    ...
    "path": "Train::TokenLocked"
        ...
        eventSelector: EventSelector.fromString("0x55600063"),
        fieldNames: ["Id","amount","token","timelock"],
      },
TokenLockAdded: {
        abiType: {
    "kind": "struct",
    ...
    "path": "Train::TokenLockAdded"
        ...
        eventSelector: EventSelector.fromString("0xec91b5e1"),
        fieldNames: ["Id","timelock"],
      },
TokenCommitted: {
        abiType: {
    "kind": "struct",
    ...
    "path": "Train::TokenCommitted"
        ...
        eventSelector: EventSelector.fromString("0x4be6553d"),
        fieldNames: ["Id","amount","token","timelock","src_receiver"],
      }
    };
  }
