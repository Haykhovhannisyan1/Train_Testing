//   _____ ____      _    ___ _   _      ____   ___  _ __     _______ ____         _    ____  ____ ____  _____ ____    _  _____ ___  ____
//  |_   _|  _ \    / \  |_ _| \ | |    / ___| / _ \| |\ \   / / ____|  _ \       / \  / ___|/ ___|  _ \| ____/ ___|  / \|_   _/ _ \|  _ \
//    | | | |_) |  / _ \  | ||  \| |    \___ \| | | | | \ \ / /|  _| | |_) |     / _ \| |  _| |  _| |_) |  _|| |  _  / _ \ | || | | | |_) |
//    | | |  _ <  / ___ \ | || |\  |     ___) | |_| | |__\ V / | |___|  _ <     / ___ \ |_| | |_| |  _ <| |__| |_| |/ ___ \| || |_| |  _ <
//    |_| |_| \_\/_/   \_\___|_| \_|    |____/ \___/|_____\_/  |_____|_| \_\   /_/   \_\____|\____|_| \_\_____\____/_/   \_\_| \___/|_| \_\
//                                                                                                                                                                                                           |___/ |___/          |___/
...
contract SolverDiscovery {
  ...
  event DiscoveryStopped(bytes32 indexed SolverKey, address indexed feePayer, uint256 refundAmount);
  ...
  function register(
    ...
    require(V8token.balanceOf(msg.sender) >= tokensAmount, 'Insufficient Balance');
    require(V8token.allowance(msg.sender, address(this)) >= tokensAmount, 'No Allowance');
  ...
  function stopDiscovery(bytes32 key) public returns (bool) {
    ...
    uint256 refundAmount = ((solver.expiryTime - block.timestamp) / (60 * 60 * 24)) * tokensPerDay;
    solver.expiryTime = 0;
